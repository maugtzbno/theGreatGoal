...
export class Optimization extends Component {
    ...
    addYield = () => {
        this.props.updateRates("addYield");
        this.setState({
            rateSavings: this.state.rateSavings +.01,
            rateRetire: this.state.rateRetire +.01
        });
        API.getScenario(this.props.values).then(x => {
            this.props.updateScen(x);
        });
    }

    minusYield = () => {
        this.props.updateRates("minusYield");
        this.setState({
            rateSavings: this.state.rateSavings -.01,
            rateRetire: this.state.rateRetire -.01
        });
